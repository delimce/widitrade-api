...
use App\Api\Application\Content\ContentListService;
...
class ContentListController extends BaseController
{
    public function __construct(
        ...
        private readonly ContentListService $contentListService
    ) {}
    ...
    public function __invoke(Request $req): Response
    {
        try {
            ...
            $filter = $req->query->get('filter') ?: null;
            $result  = $this->okResponse(
                $this->contentListService->execute($filter)
            );
